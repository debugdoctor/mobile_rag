...
const Map<String, Map<String, String>> translations = {
  'en': {
    ...
    'knowledge.settings.chunking.helper': 'Only .txt and .md files are supported. Chunk size and overlap are counted in characters.',
    ...
    'file.unsupportedType': 'Only .txt and .md files are supported.',
    ...
    'settings.placeholder.baseUrl': 'OpenAI-compatible base URL, e.g. https://api.openai.com/v1',
    ...
    'settings.rag.helper': 'Only .txt and .md supported. Chunk size/overlap are in characters.',
  ...
  'zh-CN': {
    ...
    'chat.welcome': '可以问我任何关于文档或知识库的问题。',
    ...
    'knowledge.settings.chunking.helper': '仅支持 .txt 与 .md 文件。分块大小和重叠长度为字符数。',
    ...
    'file.unsupportedType': '仅支持 .txt 与 .md 文件。',
    ...
    'settings.placeholder.baseUrl': 'OpenAI兼容接口地址，例如 https://api.openai.com/v1',
    ...
    'settings.rag.helper': '仅支持 .txt 与 .md 文件。分块大小和重叠长度为字符数。',
